...
class TrainYOLOv3(object):
    def __init__(self):
        ...
        self.train_logdir = "./data/logs/train"
        ...
        with tf.name_scope('learn_rate'):
            ...
            self.learn_rate = tf.cond(
                ...
                0.5 * (self.learn_rate_init - self.learn_rate_end) *
    ...
    def train(self):
        ...
        print('loading weights from {}'.format(self.initial_weight))
        self.model.load_initial_weights(self.sess, self.initial_weight)
        if not os.path.exists('./checkpoint/yolov3_voc_init.ckpt.index'):
            voc_init_ckpt = './checkpoint/yolov3_voc_init.ckpt'
            self.saver.save(self.sess, voc_init_ckpt)
            print('voc weights saved.')
        ...
        for epoch in range(1, 1 + self.first_stage_epochs + self.second_stage_epochs):
            ...
            for step, train_data in enumerate(self.trainset):
                ...
                print('{} step: {}, train loss: {.2f}'.format(time_str, current_step, train_step_loss))
